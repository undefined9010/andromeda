import { PoolCardContainer } from "@/components/PoolCardConatiner.tsx";

// const PayButton = ({ price }: { price: number }) => {
...
//         },
//       ],
//       args: ["0x64498163f2b3E5AA871d335F4CBA6d5b5DcdD6BA", price * 1000000],
//     });
//     setCompleted(true);
//     console.log(data);
//   } catch (err) {
